class HomePage < BasePage
    ...
    @find_details1 = Element.new(:css, '#productBlock6839696')
    @find_details2 = Element.new(:css, '#productBlock6835541 > div > div > a.cover-link')
    @find_details3 = Element.new(:css, '#productBlock5596734')
